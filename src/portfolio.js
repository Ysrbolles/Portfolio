      ...
      experiences: [
        {
          ...
          logo_path: "leafunder.jpeg",
          duration: "Oct 2020 - Present",
          location: "Khouribga, Morocco",
          description: `<h4>⚡ Create virtual Incubation platform for OFPPT.</h4>
					...
					<p>Created a user interface using ReactJS &amp; And Design with the JavaScript state management Redux.</p>
					</div>
					</div>
					</div>
					</div>
					...
					<div className="layoutArea">
					<div className="column">
					<p>Creation of Database logic &amp; APIs with NodeJS, Socket.io &amp; MongoDB</p>
					</div>
					</div>
					</div>
					</div>
					...
					<h4>⚡ Lead Developer responsible of team managment and task assigmnets.</h4>`,
          color: "#0879bf",
        },
      ],
    },
      ...
      experiences: [
        {
          ...
          logo_path: "agriedge.jpeg",
          duration: "Mar 2020 - Sep 2020",
          location: "Ben Guerir, Rehamna, Morocco",
          description: `<h4>⚡ Create Mobile app for Farmers.</h4>
					<ul style="list-style-type: circle;">
					<li>&nbsp;Conception &amp; development of the user Interface with Figma &amp; React-native, respectively.</li>
					<li>&nbsp;Create and maintain the back-end workflow with NodeJS, MongoDB, Firebase</li>
					</ul>
					<h4>⚡ Create Admin Dashboard for AgriEdge admins</h4>
					<ul style="list-style-type: circle;">
					<li>&nbsp;Conception &amp; development of the dashboard using VueJS, Vuetify.</li>
					<li>&nbsp;Create and maintain the back&mdash;end workflow with NodeJS, MongoDB</li>
					</ul>`,
          color: "#ee3c26",
        },
      ],
